...
export class OwnableValidator extends BaseValidationModule {
  ...
  public static async create({
    ...
    if (isInitialized) {
      ...
      if (!owners) {
        throw new Error(
          "Owners are required if the module is not yet initialized"
        )
      }
      installData = encodeAbiParameters(
        [
    ...
    const account = smartAccount.client.account as Account
    const instance = new OwnableValidator(
      moduleInfo,
  ...
  public override getStubSignature(): Hex {
