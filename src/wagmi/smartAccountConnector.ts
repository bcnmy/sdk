...
import {type  ENTRYPOINT_ADDRESS_V06_TYPE, type SmartAccount } from "../accounts/utils/types"
...
>({
    ...
    smartAccountClient: SmartAccountClient<ENTRYPOINT_ADDRESS_V06_TYPE, transport, chain, account> & {
