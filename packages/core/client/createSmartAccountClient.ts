...
import { ENTRYPOINT_ADDRESS_V07_TYPE, EntryPoint } from "permissionless/_types/types";
...
>): SmartAccountClient<TEntryPoint, TTransport, TChain, TSmartAccount>{
    ...
    return client as SmartAccountClient<TEntryPoint, TTransport, TChain, TSmartAccount>
}